...
function NoliktavuDarbinieksPasutit() {
    ...
    const fetchManufacturers = async () => {
        try {
            const response = await fetch("http://localhost/noliktava_php/selectFirma.php");
    ...
    const fetchProducts = async (manufacturer) => {
        try {
            const response = await fetch(`http://localhost/noliktava_php/selectNosaukums.php?manufacturer=${manufacturer}`);
            const data = await response.json();
            setProducts(data);
        } catch (error) {
    ...
    const handleOrderSubmit = async () => {
        try {
            ...
            const response = await fetch("http://localhost/noliktava_php/pasutitPreces.php", {
                method: "POST",
                headers: {
...
export default NoliktavuDarbinieksPasutit;
